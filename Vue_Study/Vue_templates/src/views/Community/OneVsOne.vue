    ...
    <div class="topic">
        ...
        <div class="inner">
          ...
          <div class="d-flex justify-content-between">
            <!-- 차선 -->
            <h2 class="text-primary">감자({{100-calResult}}%)</h2>
            <h2 class="text-danger">고구마({{calResult}}%)</h2>
          </div>
          <div class="progress" style="height: 50px;">
            ...
            <div class="progress-bar progress-bar-striped fs-4" role="progressbar" aria-valuemin="0" aria-valuemax="100" f>  </div>
            <div class="progress-bar progress-bar-striped bg-danger fs-4" role="progressbar" aria-valuemin="0" aria-valuemax="100"> </div>
          </div>
          <div class="d-flex justify-content-around align-items-center" style="margin-top: 30px;">
            <div>
              <button @click="pickTrue" class="border btn btn-outline-primary">당연히 감자아님?</button>
            </div>
            <div>
              <button @click="pickFalse" class="border btn btn-outline-danger">무슨 소리? 고구마지~</button>
            </div>
          </div>
        </div>
    </div>
