    ...
    <div>
      <div class="d-flex justify-content-between" style="margin-bottom: 2%;">
        ...
        <div class="d-flex justify-content-end" >
          <button class="link" style="margin-right: 6px; height: 30px;" @click=openCommentForm>답글 작성하기</button> <!--클릭하면 작성버튼 띄움-->
          ...
          <!-- {{ currentUser }} {{ comment.write_comment_user }} -->
          ...
          <button style="padding-bottom: 10px;" v-if="isEditing">
            ...
            <button class="link" style="margin-left: 6px; margin-right: 6px; width: 35px; height: 30px;" @click="onUpdate">등록</button>
